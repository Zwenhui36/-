...
Page({
  data: {
    ...
    viewBg: 'white',
    feedback: [{
      content: '身体健康是人们最朴素的愿望，而健康就要从每日做起，快看看今天你过的健康吗？',
      content_type: 0,
      contract_info: '',
      myDate: '',
      role: true,
  ...
  onShow: function () {
    ...
    //提交输入框的数据
      ...
      newfeedback.push({
        ...
        myDate: mydata,
        role: false,
        img: 'https://636c-cloud1-5g9s6m4xc535a723-1310002932.tcb.qcloud.la/%E4%B8%AA%E4%BA%BA%E4%B8%AD%E5%BF%83/touxiang.jpg?sign=9e0a2025413a895b1e5f024f0ffa12aa&t=1653572254',
      },
        {
